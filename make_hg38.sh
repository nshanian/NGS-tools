...
# UCSC.
#
# Note that UCSC's hg38 build has three categories of compressed fasta
# files:
#
...
UCSC_HG38_BASE=ftp://hgdownload.cse.ucsc.edu/goldenPath/hg38/chromosomes
...
CMD="${BOWTIE_BUILD_EXE} $* ${INPUTS} hg38"
echo Running $CMD
if $CMD ; then
	echo "hg38 index built; you may remove fasta files"
else
